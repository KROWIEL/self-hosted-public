...
export const ru: Dict = {
  ...
  'offsite.aboutBody':
    'Копирование локальных бэкапов в S3-совместимое хранилище (AWS S3, Backblaze B2, Wasabi, MinIO…), чтобы копия сохранилась, даже если сервер потерян. Укажите бакет и ключи, проверьте подключение и синхронизируйте по требованию.',
