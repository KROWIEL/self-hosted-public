...
export const en = {
  ...
  'catalog.subtitle':
    'One-click apps you can install into a project. Free apps are always available; Home-Lab unlocks the full set.',
  'catalog.install': 'Install',
  'catalog.installing': 'Installing…',
  'catalog.upgradeHint': 'Requires Home-Lab or higher',
  'catalog.pickProject': 'Project',
  'catalog.pickNode': 'Node',
  'catalog.serviceName': 'Service name',
  'catalog.envTitle': 'Environment',
  'catalog.envRequired': 'Required',
  'catalog.empty': 'No catalog apps yet. Run db:seed to load the built-in set.',
  'catalog.tier.free': 'Free',
  'catalog.tier.homelab': 'Home-Lab',
  'catalog.kind.image': 'Docker image',
  'catalog.kind.compose': 'Compose',
  'catalog.installed': 'Installed — opening service…',

  // Deploy kinds (create service)
  'deploy.kind': 'Deploy kind',
  'deploy.kind.git': 'Git + template',
  'deploy.kind.image': 'Docker image',
  'deploy.kind.compose': 'Docker Compose',
  'deploy.image': 'Image',
  'deploy.imagePlaceholder': 'nginx:alpine',
  'deploy.composeFile': 'Compose file',
  'deploy.composeFileHint': 'Path inside the repository (e.g. docker-compose.yml)',
  ...
  'alerts.lockedBody':
    'Wire monitored events to Discord, Slack, Telegram, or a custom webhook and get notified automatically.',
  'alerts.adminOnly': 'Only administrators can manage alerts.',
  'alerts.channelsTitle': 'Channels',
  'alerts.channelsHint':
    'Pick Discord, Slack, or Telegram, or use a generic HTTPS webhook (Mattermost, n8n, custom).',
  'alerts.channelName': 'Name',
  'alerts.channelNamePlaceholder': 'e.g. Ops Slack',
  'alerts.channelType': 'Type',
  ...
  'alerts.chatIdPlaceholder': '-100… or @channel',
  ...
  'offsite.subtitle':
    'Mirror your local backups to S3, GCS, Azure Blob, or SFTP.',
  'offsite.lockedTitle': 'Offsite backups is a Pro feature',
  'offsite.lockedBody':
    'Automatically copy every successful backup to an off-site destination (AWS S3, GCS, Azure Blob, SFTP, MinIO, R2, B2).',
  'offsite.adminOnly': 'Only administrators can manage offsite backups.',
  'offsite.destTitle': 'Destination',
  'offsite.destHint':
    'Successful backups are uploaded automatically on a schedule. Pick a provider and fill in its fields.',
  'offsite.provider': 'Provider',
  'offsite.provider.s3': 'S3 / S3-compatible',
  ...
  'offsite.gcsHint':
    'Uses the GCS XML API via HMAC keys. Endpoint defaults to https://storage.googleapis.com — create interoperable HMAC keys in Google Cloud Console.',
  'offsite.enabled': 'Enabled',
  'offsite.endpoint': 'Endpoint',
  'offsite.region': 'Region',
  'offsite.bucket': 'Bucket',
  'offsite.prefix': 'Key / path prefix (optional)',
  ...
  'offsite.azure.accountName': 'Storage account name',
  'offsite.azure.container': 'Container',
  'offsite.azure.accountKey': 'Account key',
  'offsite.azure.connectionString': 'Connection string',
  'offsite.azure.useConnectionString': 'Use connection string',
  'offsite.sftp.host': 'Host',
  'offsite.sftp.port': 'Port',
  'offsite.sftp.username': 'Username',
  'offsite.sftp.remotePath': 'Remote path',
  'offsite.sftp.authMethod': 'Auth method',
  'offsite.sftp.authPassword': 'Password',
  'offsite.sftp.authPrivateKey': 'Private key',
  'offsite.sftp.password': 'Password',
  'offsite.sftp.privateKey': 'Private key (PEM)',
  'offsite.save': 'Save',
  'offsite.saving': 'Saving…',
  'offsite.saved': 'Destination saved.',
  'offsite.test': 'Test connection',
  'offsite.testing': 'Testing…',
  'offsite.testOk': 'Connection OK — destination is writable.',
  ...
  'offsite.aboutBody':
    'Mirror local backups to S3, Google Cloud Storage (HMAC/S3 API), Azure Blob, or SFTP so a copy survives even if the server is lost. Choose a provider, enter credentials, test, then sync on demand.',
  ...
  'certs.subtitle':
    'See domain HTTPS status, upload custom PEM certs, and review ACME / DNS settings.',
  'certs.adminOnly': 'Only administrators can manage certificates.',
  'certs.aboutTitle': 'How TLS works here',
  'certs.aboutBody':
    'By default Traefik issues and renews Let\'s Encrypt certificates (HTTP-01, or DNS-01 wildcard when ACME_WILDCARD_CERTS=1 + Cloudflare token in .env). Custom PEMs are stored encrypted and written by the agent into Traefik\'s file provider (mount .docker-data/traefik). Redeploy the service after uploading a custom cert. Panel ACME preferences below do not rewrite the Traefik container env — keep .env in sync and restart Traefik.',
  'certs.domainsTitle': 'Domains',
  'certs.noDomains': 'No domains attached to services yet.',
  'certs.colHost': 'Host',
  'certs.colService': 'Service',
  'certs.colHttps': 'HTTPS',
  'certs.colStatus': 'Certificate',
  'certs.colActions': 'Actions',
  'certs.yes': 'Yes',
  'certs.no': 'No',
  'certs.status.acme': 'Managed by Traefik ACME',
  'certs.status.custom': 'Custom certificate',
  'certs.status.httpOnly': 'HTTP only',
  'certs.clearCustom': 'Revert to ACME',
  'certs.uploadTitle': 'Upload custom certificate',
  'certs.uploadHint':
    'Paste a full-chain PEM certificate and private key for one domain. The agent writes files for Traefik; redeploy to attach labels without ACME.',
  'certs.domain': 'Domain',
  'certs.certPem': 'Certificate (PEM)',
  'certs.keyPem': 'Private key (PEM)',
  'certs.upload': 'Upload & apply',
  'certs.uploading': 'Uploading…',
  'certs.uploaded': 'Custom certificate saved and applied to the node.',
  'certs.cleared': 'Custom certificate removed; next deploy uses ACME.',
  'certs.tlsTitle': 'ACME / DNS preferences',
  'certs.tlsHint':
    'Live Traefik values come from the host .env. Preferences saved here are for the panel and documentation — update .env and restart Traefik to change issuance.',
  'certs.envAcmeEmail': 'Env ACME_EMAIL',
  'certs.envWildcard': 'Env ACME_WILDCARD_CERTS',
  'certs.envCfToken': 'Env CLOUDFLARE_DNS_API_TOKEN',
  'certs.tokenSet': 'set',
  'certs.tokenMissing': 'not set',
  'certs.acmeEmail': 'Preferred ACME email',
  'certs.dnsProvider': 'DNS provider',
  'certs.cfToken': 'Cloudflare DNS API token',
  'certs.wildcardEnabled': 'Prefer wildcard (DNS-01)',
  'certs.saveTls': 'Save preferences',
  'certs.savingTls': 'Saving…',
  'certs.tlsSaved': 'TLS preferences saved.',
